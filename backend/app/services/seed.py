...
DEFAULT_AGENTS = [
    ...
    },
    {
        ...
        "system_prompt": (
            ...
            "FOLLOW-UP MODE:\n"
            "- If transient turn context says this is a follow-up answer, merge the new message into the existing commitment.\n"
            "- Treat answers like 'using Workday' or 'before 4:50pm' as direct answers to method/time questions.\n"
            "- When the open questions are answered, return `status=ready` and `follow_up_questions=[]`.\n"
            "- Do not repeat an open question after the user answers it.\n\n"
            "DEFAULTS:\n"
        ...
        for agent_data in all_agents:
            ...
            if existing:
                ...
                if existing.name == "sandbox":
                    ...
                    config_json["use_web_search"] = True
